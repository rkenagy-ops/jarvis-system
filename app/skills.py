...
SKILLS: list[dict[str, Any]] = [
    ...
    {"id": "time", "phrases": ("time", "date", "utc"), "desc": "Local + UTC time", "src": "kishanrajput23/Jarvis-Desktop-Voice-Assistant"},
    ...
    {"id": "remind", "phrases": ("remind me", "reminder", "set a timer"), "desc": "Calendar reminder + optional notify", "src": "ethanplusai/jarvis"},
